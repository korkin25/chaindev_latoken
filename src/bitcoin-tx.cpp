...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s chaindev_latoken-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  chaindev_latoken-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded chaindev_latoken transaction") + "\n" +
              "  chaindev_latoken-tx [options] -create [commands]   " + _("Create hex-encoded chaindev_latoken transaction") + "\n" +
              "\n";
