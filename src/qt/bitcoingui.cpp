...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and chaindev_latoken: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a chaindev_latoken: URI or payment request"));
