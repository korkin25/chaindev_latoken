Litecoin Core version 0.13.3 is now available from:
  ...
  <https://download.chaindev_latoken.org/chaindev_latoken-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/chaindev_latoken-project/chaindev_latoken/blob/0.13/src/chainparams.cpp#L214).
