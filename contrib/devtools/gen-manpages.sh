...
LITECOIND=${LITECOIND:-$SRCDIR/chaindev_latokend}
LITECOINCLI=${LITECOINCLI:-$SRCDIR/chaindev_latoken-cli}
LITECOINTX=${LITECOINTX:-$SRCDIR/chaindev_latoken-tx}
LITECOINQT=${LITECOINQT:-$SRCDIR/qt/chaindev_latoken-qt}
