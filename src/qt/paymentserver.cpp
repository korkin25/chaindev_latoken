...
const QString BITCOIN_IPC_PREFIX("chaindev_latoken:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/chaindev_latoken-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/chaindev_latoken-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/chaindev_latoken-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start chaindev_latoken: click-to-pay handler"));
        }
        else {
