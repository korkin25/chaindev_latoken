...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.chaindev_latoken.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.chaindev_latokentools.com", true);
        vSeeds.emplace_back("dnsseed.chaindev_latokenpool.org", true);
...
public:
    CTestNetParams() {
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x89, 0xFE};
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x85, 0xAD};
