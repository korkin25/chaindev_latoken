Litecoin Core version 0.10.2.2 is now available from:
  ...
  <https://download.chaindev_latoken.org/chaindev_latoken-0.10.2.2/>
...
chaindev_latokend/chaindev_latoken-qt (on Linux).
...
- chaindev_latokend no longer sends RPC commands.  You must use the separate chaindev_latoken-cli command line utility.
