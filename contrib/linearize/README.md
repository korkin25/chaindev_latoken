...
JSON-RPC server. Running `chaindev_latokend` or `chaindev_latoken-qt -server` will be sufficient.
...
* `input`: chaindev_latokend blocks/ directory containing blkNNNNN.dat
