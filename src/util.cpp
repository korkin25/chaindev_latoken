...
const char * const BITCOIN_CONF_FILENAME = "chaindev_latoken.conf";
const char * const BITCOIN_PID_FILENAME = "chaindev_latoken.pid";
...
#else
    const char* pszModule = "chaindev_latoken";
#endif
    if (pex)
        return strprintf(
...
#else
    // Unix
    return pathRet / ".chaindev_latoken";
#endif
#endif
}
